    ...
    public class MainViewModel : BaseViewModel
    {
        ...
        private List<CustomContextMenuViewModel> BuildMenus(string action, ICommand command)
        {
            ...
            if (this.EnvironmentsViewData != null && this.EnvironmentsViewData.Environment != null)
            {
                ...
                {
                    var childEnvMenu = new CustomContextMenuViewModel(action + ": " + env.Name, null, null);
        ...
        private void BuildVariables(GlobalVariableModel global)
        {
            ...
            if (global.Certificates != null)
            {
                certs.AddRange(global.Certificates.Where(x => certs.Any(y => y.Name.Equals(x.Name, StringComparison.CurrentCultureIgnoreCase)) == false));
            }
        ...
        {
            var newEnvironment = _view.ViewEnvironmentWindow(this.GlobalVariables, env);
            this.LoadEnvironmentData();
